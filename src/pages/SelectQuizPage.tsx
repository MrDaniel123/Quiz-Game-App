...
const ButtonPlay = styled.button`
  ...
  filter: drop-shadow(0px -2px 80px rgba(0, 0, 0, 0.26)) drop-shadow(0px -1.411px 37.2764px rgba(0, 0, 0, 0.201119)) drop-shadow(0px -0.978767px 18.4264px rgba(0, 0, 0, 0.169646)) drop-shadow(0px -0.62734px 8.45616px rgba(0, 0, 0, 0.136794)) drop-shadow(0px -0.309258px 2.8906px rgba(0, 0, 0, 0.0907709));
`;
